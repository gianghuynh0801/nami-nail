...
import { Building2, Plus, Calendar, DollarSign, TrendingUp, Phone, Copy, Check, Link as LinkIcon } from 'lucide-react'
...
export default function BranchesPage() {
  const t = useTranslations('DashboardPages.branches')
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <div className="text-xs text-gray-500">
                      {t('created')}: {format(new Date(salon.createdAt), 'dd/MM/yyyy', { locale: dateLocale })}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-200">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-500">{t('appointments')}</div>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-semibold text-gray-900">{salon._count?.services || 0}</div>
                      <div className="text-xs text-gray-500">{t('services')}</div>
                    </div>
                    <div className="text-center">
