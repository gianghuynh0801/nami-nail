...
import { Plus, Search, Edit, Trash2, Phone, User as UserIcon } from 'lucide-react'
...
export default function StaffPage() {
  ...
  if (salonLoading) return <div className="p-8 text-center text-gray-500">Đang tải...</div>

  if (!selectedSalonId) {
    return (
      <div className="p-8 text-center bg-gray-50 min-h-screen flex flex-col justify-center items-center">
        <p className="text-gray-500 mb-4">Vui lòng chọn chi nhánh để quản lý thợ nail.</p>
      </div>
    )
  }
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">Danh sách nhân viên và thông tin liên hệ</p>
          </div>
          <button
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          {loading ? (
            ...
            <div className="p-12 text-center text-gray-500">
              {searchQuery ? 'Không tìm thấy kết quả nào' : 'Chưa có nhân viên nào. Hãy thêm nhân viên mới!'}
            </div>
          ) : (
                      ...
                      <tr key={staff.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          {staff.phone ? (
                            ...
                            <span className="text-sm text-gray-400 italic">Chưa cập nhật SĐT</span>
                          )}
                        </td>
