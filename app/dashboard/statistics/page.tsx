...
export default function StatisticsPage() {
  ...
  const appointmentStatsData = statistics?.appointmentStats ? [
    { name: 'Hoàn thành', value: statistics.appointmentStats.COMPLETED || 0 },
    { name: 'Đã xác nhận', value: statistics.appointmentStats.CONFIRMED || 0 },
    { name: 'Chờ xác nhận', value: statistics.appointmentStats.PENDING || 0 },
    { name: 'Đã hủy', value: statistics.appointmentStats.CANCELLED || 0 },
  ] : []

  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <h1 className="text-3xl font-bold text-gray-800">Thống kê và Báo cáo</h1>
      </div>
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-500">Lịch hẹn hoàn thành</p>
                  <p className="text-2xl font-bold text-gray-900 mt-1">
          ...
          {statistics.revenueBySalon.length > 0 && (
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Doanh thu theo chi nhánh</h3>
              <ResponsiveContainer width="100%" height={300}>
          ...
          {statistics.topServices.length > 0 && (
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Top dịch vụ</h3>
                ...
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Số lịch hẹn</th>
                      <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Doanh thu</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-200">
